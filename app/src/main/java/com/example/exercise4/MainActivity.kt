        ...
        DOBInput.setOnClickListener(){
            ...
            val dpd = DatePickerDialog(this,
                DatePickerDialog.OnDateSetListener {
                    ...
                    basicSavingInput.text = "RM " + (basicSaving).toString()
                    investAmtInput.text = "RM " + (basicSaving * 0.30).toString()
                    ageInput.setText(currentAge.toString());
